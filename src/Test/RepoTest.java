...
public class RepoTest {
    ...
    public void setup(){
        ...
        courseInMemoryRepository.add(new Course("FP",teacherInMemoryRepository.getAll().get(0), 10, students, 5));
    ...
    public void testAdd(){
        ...
        assertEquals(courseInMemoryRepository.getAll().get(0), new Course("FP",teacherInMemoryRepository.getAll().get(0), 10, students, 5));
    }
    ...
    public void testUpdate(){
        ...
        courseInMemoryRepository.update(courseInMemoryRepository.getAll().get(0), new Course("FP",teacherInMemoryRepository.getAll().get(0), 10, students, 5));
